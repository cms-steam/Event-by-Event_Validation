...
# options
scenario=1  # 0 = Fall13, 25 ns; 1 = Fall13, 50 ns; 2 = Spring14, 25 ns;
...
if scenario==0:
    inputFile = 'inputFiles_hlt_Fall13_25ns.txt'
    outputFile = 'histo_hlt_eventbyevent_comparison_Fall13_25ns.root'
elif scenario==1:
    inputFile = 'inputFiles_hlt_Fall13_50ns.txt'
    outputFile = 'histo_hlt_eventbyevent_comparison_Fall13_50ns.root'
elif scenario==2:
    inputFile = 'inputFiles_hlt_Spring14_25ns.txt'
    outputFile = 'histo_hlt_eventbyevent_comparison_Spring14_25ns.root'
...
readFiles = cms.untracked.vstring( FileUtils.loadListFromFile(inputFile) )
